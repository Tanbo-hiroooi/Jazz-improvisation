...
export const EXERCISES: Exercise[] = [
  // ---- A. コードトーン ----
  {
    ...
    descriptionEn: 'Use chord tones only. Play 2–4 notes per bar and always include a rest.',
    ...
    rules: [
      ...
      r('ct1-max', 'max-notes', '1小節に2〜4音まで', '2–4 notes per bar'),
      r('ct1-rest', 'required-rest', '各小節に必ず休符を入れる', 'Include a rest in every bar'),
    ],
  },
  {
    id: 'ct-strong-beat',
  ...
  // ---- C. ターゲットノート ----
  {
    ...
    descriptionEn: 'Find the next chord’s 3rd and build a short phrase toward it, landing on beat 1 of the next bar.',
  ...
  },
  {
    ...
    difficulty: 2,
    rules: [r('rh2-rest', 'required-rest', '各小節の1拍目は休符', 'Beat 1 of every bar is a rest')],
  },
  // ---- F. モチーフ展開 ----
  {
    id: 'mo-repeat-vary',
    ...
    descriptionEn: 'Create a 2–4 note motif in the first two bars; in the next two, change only the rhythm or the last note.',
  ...
  },
  {
    ...
    descriptionEn: 'Include at least one full beat of rest every two bars. Space is part of the phrase.',
