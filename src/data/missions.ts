...
export const PRACTICE_MISSIONS: PracticeMission[] = [
  ...
  },
  {
    ...
    descriptionEn: 'Sound the 3rd of every chord at least once in its bar.',
  ...
  },
  {
    ...
    descriptionEn: 'The anti-overplaying mission: at least one beat of rest every two bars.',
