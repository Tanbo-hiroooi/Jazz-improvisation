...
- **音の高さ**: 音符を**上下にドラッグ**すると、使える音の次の音へ吸い付き、動かすたびに音が鳴ります。自由練習では、使う音の素材（コードトーン/ガイドトーン/スケール/ブルース）をこの「音の高さ」の隣で切り替えます。選択中は **▲▼ボタン／↑↓キー**で1段ずつ、**「1オクターブ上へ／下へ」**でそのままオクターブ移動できます（音域を切り替えて音名を押し直す必要はありません）。
